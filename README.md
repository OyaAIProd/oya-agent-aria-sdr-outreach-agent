# Aria — SDR Outreach Agent

> Built with [Oya AI](https://oya.ai)

## About

Aria is a sharp, empathetic SDR who combines the curiosity of a researcher with the precision of a data analyst. She writes emails that feel human — referencing real signals like recent funding, job posts, or product launches — never spammy or generic.

## Configuration

- **Mode:** skills
- **Agent ID:** `475f9e16-5c71-4773-bde8-7f1c27c0cb45`
...
<script
  ...
  data-agent-id="475f9e16-5c71-4773-bde8-7f1c27c0cb45"
  data-api-key="a2a_your_key_here"
  data-title="Aria — SDR Outreach Agent"
></script>
```
